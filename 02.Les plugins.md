...
1. Copiez les éléments suivants dans votre fichier de composant de mise en page:
```JSX
import React from "react"
...
Défi: Avec vos nouveaux «composants de mise en page», essayez d’ajouter des en-têtes, des pieds de page, la navigation globale, des barres latérales, etc. à vos sites Gatsby!

[03. Les données dans Gatsby](https://github.com/PoulainNicolas/gatsby/edit/master/03.%20Les%20donn%C3%A9es%20dans%20Gatsby.md)
