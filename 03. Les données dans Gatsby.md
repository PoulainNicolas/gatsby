...
Donc, presque partout, les modifications que vous apportez prendront effet immédiatement. Modifiez le gatsby-config.jsfichier à nouveau, en remplaçant cette fois title«Pandas Eating Lots». Le changement devrait apparaître très rapidement dans les pages de votre site.
